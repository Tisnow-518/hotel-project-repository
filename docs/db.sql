...
CREATE TABLE `branch` (
  `branch_id` int NOT NULL AUTO_INCREMENT COMMENT '主键，自增',
  `branch_name` varchar(100) NOT NULL COMMENT '分店名称',
  `branch_address` varchar(255) NOT NULL COMMENT '分店地址',
  `branch_phone` varchar(30) NOT NULL COMMENT '分店电话',
...
-- 插入示例分店数据
INSERT INTO `branch` (`branch_name`, `branch_address`, `branch_phone`, `room_count`, `photo_url`, `created_by`, `is_deleted`) VALUES
